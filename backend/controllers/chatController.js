...
const get_all_chats = asyncHandler(async (req, res, next) => {
...
const get_chat = asyncHandler(async (req, res, next) => {
...
const add_chat = asyncHandler(async (req, res, next) => {
  const { userId } = req.params;
  const user = await User.findById(userId).exec();
...
const delete_chat = asyncHandler(async (req, res, next) => {
  const { userId, chatId } = req.params;
...
const remove_user = asyncHandler(async (req, res, next) => {
...
const add_user = asyncHandler(async (req, res, next) => {
  const { chatId, userId } = req.params;
  const chat = await Chat.findById(chatId).exec();
  const user = await User.findById(userId).exec();
  ...
  res.json({ message: "User successfully added to chat", chat: chat });
});
